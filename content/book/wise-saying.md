...
by: Yehor 
---
坚持胜于强度, 少学习，但要每天学习。<br><br>

先学习一些基本的词汇（可以谷歌一下），以及一些语法知识（不需要完全理解），然后尝试理解一些原生内容，比如视频等等。
::
